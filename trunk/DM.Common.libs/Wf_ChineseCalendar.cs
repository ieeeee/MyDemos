...
namespace DM.Common.libs
{
    ...
    /// cncxz（虫虫） 2007-2-9
    /// </summary>
    public sealed class Wf_ChineseCalendar
    {
        ...
        public Wf_ChineseCalendar(DateTime date)
        {
            m_SolarDate = date;
            LoadFromSolarDate();
        }
        ...
        /// <param name="day">阴历日</param>
        /// <param name="IsLeapMonth">是否闰月</param>
        public static Wf_ChineseCalendar FromLunarDate(int year, int month, int day, bool IsLeapMonth)
        {
            DateTime dt = GetDateFromLunarDate(year, month, day, IsLeapMonth);
            return new Wf_ChineseCalendar(dt);
        }
        /// <summary>
        /// 从阴历创建日历实体
        /// </summary>
        /// <param name="date">阴历日期</param>
        /// <param name="IsLeapMonth">是否闰月</param>
        public static Wf_ChineseCalendar FromLunarDate(DateTime date, bool IsLeapMonth)
        {
        ...
        /// <param name="IsLeapMonth">是否闰月</param>
        public static Wf_ChineseCalendar FromLunarDate(string date, bool IsLeapMonth)
        {
